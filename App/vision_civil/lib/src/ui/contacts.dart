...
class ContactsPageState extends State<ContactsPage> {
  ...
  Widget build(BuildContext context) {
    BlocProvider.of<ContactsblocBloc>(context).add(GetUserContacts());
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
            ...
            listener: (context, state) {
              setState(() {
                try {
                  ...
                  contactPhone1 = state.emergencyUserContacts[0].contactPhone;
                } catch (e) {
                  uniqueContact1 = " ";
                  contactName1 = " ";
                }
                try {
                  ...
                  contactPhone2 = state.emergencyUserContacts[1].contactPhone;
                } catch (e) {
                  uniqueContact2 = " ";
                  contactName2 = " ";
                }
                try {
                  ...
                  contactPhone3 = state.emergencyUserContacts[2].contactPhone;
                } catch (e) {
                  uniqueContact3 = " ";
                  contactName3 = " ";
                }
