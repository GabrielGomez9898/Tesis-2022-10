...
const ColumnCell = (props) => {
    ...
    if (isFunctionary) {
        if (props["isMaster"]) {
            isMasterText = "Funcionario master";
        }
        else {
            isMasterText = "Funcionario normal";
        }
    }
    ...
    return (
        (isFunctionary) ? (
            <div className="users-table-column-cell">
                ...
                {isDeleteFunctionaryModalOpen ? <DeleteFunctionaryModal functionaryId={props.functionaryId} onClose={() => setIsDeleteFunctionaryModalOpen(false)}/> : null}
            </div>
        ) : (
            <div className="users-table-column-cell">
                <div className="users-table-column-cell-data">
