...
## **Visión Civil Mobile**
The technical details on the Mobile app can be found on [the mobile app README.md](App/)
...
## **Visión Civil Web**
The technical details on the web app can be found on [the web app README.md](WebPage/)
